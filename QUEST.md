...
✔️ 수정 이유
  - 코어타임 1시간 마다는 너무 많소, 하루에 한번으로 합시다!
...
✔️ 유지 이유
  - `함께자라기`에 나왔던 내용과도 일치한다. 몰입도를 올리기 위해 난이도가 높은 미션을 세분화해서 달성함으로써 몰입도를 높일 수 있을 것 같다.

---

### 퀘스트 3️⃣

✔️ 퀘스트: 미션을 수행하며 찾아봤던 좋은 자료 `Slack`에 공유 하기

✔️ 수행 기준

- 미션 해결을 위해 찾아본 다양한 자료중에 내가 판단했을때 가장 도움이 되었다고 생각하는 자료를 공유해본다.
- 1주일에 한 개만 공유해도 OK!

✔️ 수정 이유

- 미션과 관련없는 글을 읽기에는 여유가 부족한 것 같아 미션과 관련된 내용을 수행할 수 있도록 수정해보았습니다.

- 미션과 관련된 내용을 공부하고 직접 적용해봄으로써 보다 확실한 학습이 되도록 바꿔보았습니다.

- 단순히 읽는 것이 끝나는 것이 아니라 부스트캠프 커뮤니티를 위해 공유하는 것으로 확장해보았습니다.
...
**하루에 한 번 나를 칭찬하거나, 내가 잘한점 글로 적어보기**

✔️ 수정 이유

- 보다 구체적으로 내가 잘한점을 찾음으로써 자존감 UP!

---
 
### 퀘스트 5️⃣

✔️ 퀘스트: 과거 `day01 ~ day13` 미션 중 자신의 코드를 하나 찾아 리펙토링하기

✔️ 수행 기준
- 매일해야할 필요는 없습니다. 
- 양의 기준은 없습니다. 
- _**한 줄의 코드여도 상관없고 함수의 네이밍을 다시하는 것도 상관없습니다.**_ 
- 이전 코드와 개선 코드를 작성하여 업로드 바랍니다.

✔️ 수정 이유
- 지난 3주간 내가 뭘 했는지 한 번 돌아보는 시간을 가져보아요!
...
✔️ 유지 이유
- 부담없이 가벼운 것을 보면서 잠시 휴식을 할 수 있는데, 개발 지식도 늘릴 수 있다? 완전 럭키비키~☆
...
- 미션 수행을 위한 여유가 없다고 판단되어 삭제하였습니다!
